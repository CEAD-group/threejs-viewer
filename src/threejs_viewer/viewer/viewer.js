...
export class ThreeJSViewer {
    ...
    _maybeNotifyAssetsLoaded() {
        ...
        // The WS notification is gated on an open socket; the embedder hooks
        // are not — a no-WebSocket page feeding handleMessage() directly is
        // exactly the case that needs them (issue #163).
