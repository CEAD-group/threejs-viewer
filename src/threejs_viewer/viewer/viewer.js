...
// - strandCollapse: When true, every per-cross-section-vertex strand
//                 polyline is scanned for fold targets (3D seg-seg
//                 closest-pair local minima within a sliding window) and
//                 the rings inside each fold range are snapped to the
//                 closest-pair midpoint. See collapseTubeStrandFolds.
//
...
function buildParametricTubeGeometry(
    ...
    if (strandCollapse) {
        collapseTubeStrandFolds(positions, spine, widths, heights, localFrames, nSpine, nCs);
    }
                        ...
                        (async () => {
                            try {
                                ...
                                if (tubeLOD) {
                                    ...
                                    mesh.userData.tubeStrandCollapse = strandCollapse;
