...
// Abort-tracking key for the (id-less) animation blob fetch. Not a real
// object id, so it can never collide with one in _loadAborts.
const ANIMATION_FETCH_KEY = '\u0000animation';
...
export class ThreeJSViewer {
    ...
    /** @param {string} id @param {AbortController} controller */
